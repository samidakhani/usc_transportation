...
STUDENT_ID VARCHAR2(4) PRIMARY KEY,
STUDENT_LOC SDO_GEOMETRY);

CREATE TABLE BUILDING(
BUILDING_ID VARCHAR2(4) PRIMARY KEY,
BUILDING_NAME VARCHAR2(30),
BUILDING_LOC SDO_GEOMETRY);

CREATE TABLE TRAMSTOP(
TRAMSTOP_ID VARCHAR2(10) PRIMARY KEY,
TRAMSTOP_LOC SDO_GEOMETRY);
...
INSERT INTO STUDENT VAlUES(
'p29',SDO_GEOMETRY(2001,NULL,SDO_POINT_TYPE(516,209,NULL),NULL,NULL));
...
INSERT INTO STUDENT VAlUES(
'p50',SDO_GEOMETRY(2001,NULL,SDO_POINT_TYPE(197,275,NULL),NULL,NULL));
...
'b0','PSA',SDO_GEOMETRY(2003,NULL,NULL,
...
INSERT INTO BUILDING VALUES(
'b1','OHE',SDO_GEOMETRY(2003,NULL,NULL,
  SDO_ELEM_INFO_ARRAY(1,2003,1),
  SDO_ORDINATE_ARRAY(226, 150, 254, 164, 240, 191, 212, 176,226, 150)));


INSERT INTO BUILDING VALUES(
'b2','BHE',SDO_GEOMETRY(2003,NULL,NULL,
  SDO_ELEM_INFO_ARRAY(1,2003,1),
...
INSERT INTO BUILDING VALUES(
'b3','VHE',SDO_GEOMETRY(2003,NULL,NULL,
  SDO_ELEM_INFO_ARRAY(1,2003,1),
...
INSERT INTO BUILDING VALUES(
'b4','HED & PCE',SDO_GEOMETRY(2003,NULL,NULL,
  SDO_ELEM_INFO_ARRAY(1,2003,1),
...
INSERT INTO BUILDING VALUES(
'b15','SSL',SDO_GEOMETRY(2003,NULL,NULL,
  SDO_ELEM_INFO_ARRAY(1,2003,1),
...
INSERT INTO BUILDING VALUES(
'b32','TSC',SDO_GEOMETRY(2003,NULL,NULL,
  SDO_ELEM_INFO_ARRAY(1,2003,1),
  SDO_ORDINATE_ARRAY(677, 320, 708, 337, 690, 368, 661, 351,677, 320)));
  
INSERT INTO BUILDING VALUES(
'b33','HNB',SDO_GEOMETRY(2003,NULL,NULL,
  SDO_ELEM_INFO_ARRAY(1,2003,1),
...
SDO_DIM_ARRAY(
     ...
     SDO_DIM_ELEMENT('Y',0,800,0.005)),NULL);
